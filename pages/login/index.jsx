...
const Login = () => {
  ...
  const handleLogin = (e) => {
    ...
    axios
      .post("https://altapro.online/login", user)
      .then((res) => {
        const data = res.data;
        ...
        swal(
          "Login Successfully",
          `Welcome to segoro , ${data.user}`,
          "success"
        ).then(() => (window.location.href = "/"));
      })
      .catch((err) =>
        swal("Login Failed", `${err.response.data.message}`, "error")
      );
  };
  ...
  const handleRegister = (e) => {
    ...
    axios
      .post("https://altapro.online/users", data)
      .then((res) =>
        swal(
          "Register Successfully",
          `Login now to access segoro`,
          "success"
